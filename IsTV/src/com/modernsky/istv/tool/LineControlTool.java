...
import com.modernsky.istv.MediaButtonReceiver;
 ...
 */
public class LineControlTool {

    private static LineControlTool headSetUtil;
    private OnHeadSetListener headSetListener = null;

    public static LineControlTool getInstance() {
        if (headSetUtil == null) {
            headSetUtil = new LineControlTool();
        }
        return headSetUtil;
    }
