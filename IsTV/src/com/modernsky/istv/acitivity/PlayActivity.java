...
public class PlayActivity extends BaseActivity implements MediaPlayerControl,
        OnMediaControllerClickedListener, OnPlayStateListener {
    // 乐视
...
//        Utils.sendBroadcastToService(8, this);
    ...
    private void initPlayContext() {
        ...
        playContext = new PlayContext(this.getApplicationContext());
    ...
    public void setContentView(Bundle savedInstanceState) {
        ...
        bitmapTool = BitmapTool.getInstance().initAdapterUitl(PlayActivity.this);
        reSetWindowSize();
        initView();
        // 获取电话通讯服务
    ...
    private void initViewPager() {
        ...
        xuanjiFragment = (xuanjiFragment == null) ? new XuanjiFragment() : xuanjiFragment;
        playFragment = (playFragment == null) ? initplayFragment() : playFragment;
        adapter.addFragment(xuanjiFragment, getResources().getString(R.string.xuanji));
    ...
    public void findViewById() {
        ...
        if (Constants.ARTIST_ALL_VIDEO.equals(getStringType())) {
            xuanjiFragment.getArtistAllVideo(mCollectId, mIndex);
        }
        if (Constants.TYPE_ARTIST.equals(getStringType())) {
            xuanjiFragment.getArtistDetailData(objectId, albumId);
            playAlbum(albumId);
        }
    ...
    public void playVideoByUrl(final String videoId, String foreignUnique, String videoName) {
        ...
        getIfZanAndIfShoucang(videoId);
        vu = foreignUnique;
//        LogUtils.d("iswiff------"+NetworkHelper.isWifi(this));
        LogUtils.d("network==" + NetworkHelper.isNetworkConnected(this) + "iswiff" + NetworkHelper.isWifiConnected(this) + "isshow===" + PreferencesUtils.getBooleanPreferences(this,
...
//        //默认初始化播放高清
//        this.mPlayerView.selectRateType("13");
//        if (isPlaying())
//            mPlayerView.stopVideo();
//        LogUtils.d("uu=" + uu + "vu=" + vu);
//        mPlayerView.playVideo(uu, vu, "", "", "ceshi", false);
//        LogUtils.d("setPlayUrl");
        getMyMediaController().setVideoShowName(mTitle);
...
//            player.start();
    ...
    private void addPlayToServices(String videoId) {
        ...
        SendActtionTool.post(Constants.URL_RECORD_SERVLET, ServiceAction.Action_Comment, CommentAction.Action_addPlayToServices, this, params);
    }
    ...
    public void playAlbum(String albumId) {
        if (!TextUtils.isEmpty(albumId)) {
            ...
            params.addQueryStringParameter(Constants.ALBUM_ID, albumId);
            // params.addQueryStringParameter(Constants.USER_ID, userId);
            params.addQueryStringParameter(Constants.FILTER,
                    Constants.FILTER_ALBUM);
            SendActtionTool.get(Constants.URL_ALBUM_DETAIL,
                    ServiceAction.Action_Comment,
...
//    }
    ...
    private void initView() {
        ...
        ll_descrption = (LinearLayout) findViewById(R.id.ll_descrption);
        // ~~~ 绑定数据
        ...
        getMyMediaController().setVerticalMode(2);
        getMyMediaController().show();
        getGestureDetector();
        addAd();
...
//                    seekToPos(seekToTime);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            LogUtils.d("qwwqqwqwonConfigurationChanged横屏");
    ...
    public void onSuccess(ServiceAction service, Object action, Object value) {
        ...
        switch ((CommentAction) action) {
            case Action_GetLastVideo_By_Id:
                try {
                    ResultBean<AlbumLastVideo> resultBean = JSON
                            .parseObject(
                                    jsonString,
                                    new TypeReference<ResultBean<AlbumLastVideo>>() {
                                    });
                    if (resultBean != null) {
                        AlbumLastVideo albumLastVideo = resultBean.data;
                        LatestVideo latestVideo = albumLastVideo
                                .getLatestVideo();
...
//            int commentCount = value.getInt("commentCount");
    ...
    private void setLiveUrlandPlay(LatestVideo albumLastVideo) {
        ...
        if ("3".equals(albumLastVideo.getIsVRsource().trim()) && albumLastVideo.getVideoType() == 1) {
            VideoPlayInfo videoPlayInfo1 = albumLastVideo.getVideoPlayInfo();
            Utils.playVRNetworkStream(this, videoPlayInfo1.getVideoUrl(), albumLastVideo.getName());
            finish();
            return;
        }
...
//    private boolean needResume;
    ...
    public void onShareClicked() {
        ...
        share(mTitle, mTitle, videoId + "_" + vu);
    }
...
//            formDialog.show();
//        } else {
//            formDialog = DialogTool.createFormDialog(this, this);
//        }
//        isDialogShow = true;
    }
    ...
    private void shouCang(String resouceId) {
        ...
        RequestParams params = UrlTool.getParams(Constants.USER_ID, userId,
                Constants.RESOURCE_ID, resouceId, Constants.TYPE, "1");
     ...
     * 取消收藏视频
     */
    private void cancleShoucang(String resouceId) {
        if (!isUesrLogined()) {
            return;
        }
        RequestParams params = UrlTool.getParams(Constants.USER_ID, userId,
                "resourceId", resouceId, Constants.TYPE, "1");
//        RequestParams params = UrlTool.getParams(Constants.USER_ID, userId,
//                Constants.VIDEO_ID, resouceId);
    ...
    protected void onActivityResult(int arg0, int arg1, Intent intent) {
        ...
        if (action.equals(Constants.ACTION_PAY_RESULT)) {
            ...
            if (intExtra == 0) {
                ...
                Utils.toast(PlayActivity.this, R.string.pay_success);
            } else
                Utils.toast(PlayActivity.this, R.string.pay_fail);
        }
...
//                && mPlayerView.getCurrentPlayState() == PlayerStateCallback.PLAYER_VIDEO_PAUSE)
    }
...
//        String tagUrl = "http://wap.zhengzai.tv/pages/videoshare.html?vbreId=" + vebreId;
        String tagUrl = Constants.tagUrl + vebreId;
        share = new PopThreeShare(this);
        share.setShareUrlForAnchor("正在现场", mTitle, tagUrl, "", vu);
