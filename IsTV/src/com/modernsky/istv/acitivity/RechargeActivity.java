...
public class RechargeActivity extends BaseActivity {
    ...
    public void findViewById() {
        ...
        findViewById(R.id.rb_zhifubao).setOnClickListener(this);
        findViewById(R.id.rb_weixin).setOnClickListener(this);
        findViewById(R.id.edit_back).setOnClickListener(this);
        mTextMoney = (TextView) findViewById(R.id.textView2);
        mTextMoney.setText("￥" + rechargeBean.getMoney());
        mTextMB = (TextView) findViewById(R.id.textView4);
        mTextMB.setText(rechargeBean.getMb() + "M豆");
    }
    ...
    public void onSuccess(ServiceAction service, Object action, Object value) {
        ...
        switch ((PayAction) action) {
            ...
            case Action_sentWeixinBack:
                ...
                RechargeActivity.this.setResult(RESULT_OK, mIntent);
                // 关闭Activity
