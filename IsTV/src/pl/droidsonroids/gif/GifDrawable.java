...
public class GifDrawable extends Drawable implements Animatable,
     ...
     * @param resolver resolver used to query {@code uri}, can be null for file://
     *                 scheme Uris
     ...
     * @throws ArrayIndexOutOfBoundsException if the pixels array is too small to receive required number
     *                                        of pixels
     */
     ...
     * @param restart when visible, true to force the animation to restart from the
     *                first frame
